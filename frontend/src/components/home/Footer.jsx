      ...
      <div className="container mx-auto px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              A community of faith committed to worship, discipleship, and serving 
              others through the transformative love of Jesus Christ.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="h-10 w-10 rounded-full bg-indigo-600 flex items-center justify-center transition-colors duration-300 hover:bg-indigo-500">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['About', 'Sermons', 'Events', 'Gallery', 'Blog', 'Contact Us'].map((link, index) => (
                <li key={index}>
                  <Link 
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <div>
                  <p className="font-medium text-white">Wednesday Bible Study</p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <p className="text-gray-400">info@gracechapel.org</p>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Grace Chapel. All rights reserved.
          </p>
